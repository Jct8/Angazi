...
namespace MathTest
{
	...
	public:
		...
		TEST_METHOD(TestNormalize)
		{
			...
			Assert::AreEqual(q1.x, 0.1825742f, 0.000001f);
			Assert::AreEqual(q1.y, 0.3651484f, 0.000001f);
			Assert::AreEqual(q1.z, 0.5477226f, 0.000001f);
			Assert::AreEqual(q1.w, 0.7302967f, 0.000001f);
		}
