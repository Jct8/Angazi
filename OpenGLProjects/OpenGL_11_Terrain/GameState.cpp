...
void GameState::Initialize()
{
	...
	mVertexShader.Initialize("../../Assets/GLShaders/Standard.glsl", BoneVertex::Format);
	mPixelShader.Initialize("../../Assets/GLShaders/Standard.glsl");
	...
	mDepthMapVertexShader.Initialize("../../Assets/GLShaders/DepthMap.glsl", BoneVertex::Format);
	mDepthMapPixelShader.Initialize("../../Assets/GLShaders/DepthMap.glsl");
