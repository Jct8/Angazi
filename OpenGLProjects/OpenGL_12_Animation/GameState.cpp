...
void GameState::Initialize()
{
	...
	// Post Processing
	mPostProcessingEffect.Initialize("../../Assets/GLShaders/PostProcessing.glsl", "VS", "PSNoProcessing");
	...
	// Effects
	mModelStandardEffect.Initialize("../../Assets/GLShaders/Standard.glsl");
	mModelStandardEffect.UseShadow(true);
	mModelStandardEffect.SetNormalMapWeight(1.0f);
	mModelStandardEffect.SetSkinnedMesh(1.0f);

	mGroundStandardEffect.Initialize("../../Assets/GLShaders/Standard.glsl");
	...
	mShadowEffect.Initialize("../../Assets/GLShaders/DepthMap.glsl");
