...
void GameState::Initialize()
{
	...
	mPhongShadingVertexShader.Initialize("../../Assets/GLShaders/Earth.glsl", Vertex::Format, "VSEarth");
	mPhongShadingPixelShader.Initialize("../../Assets/GLShaders/Earth.glsl", "PSEarth");

	mCloudShadingVertexShader.Initialize("../../Assets/GLShaders/Earth.glsl", Vertex::Format, "VSCloud");
