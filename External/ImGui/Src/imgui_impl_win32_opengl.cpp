...
#include "imgui.h"
#include "imgui_impl_win32_opengl.h"
...
////////////////////// Fix for OpenGL - Win32 //////////////////////
//- https://github.com/ocornut/imgui/issues/2600#issuecomment-526830024 
//
...
// Functions
bool    ImGui_ImplWin32_opengl_Init(void* hwnd, void* glcontext)
{
...
void    ImGui_ImplWin32_opengl_Shutdown()
{
...
void    ImGui_ImplWin32_opengl_NewFrame()
{
	ImGuiIO& io = ImGui::GetIO();
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_opengl_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void ImGui_ImplWin32_opengl_EnableDpiAwareness()
{
...
float ImGui_ImplWin32_opengl_GetDpiScaleForMonitor(void* monitor)
{
...
float ImGui_ImplWin32_opengl_GetDpiScaleForHwnd(void* hwnd)
{
	HMONITOR monitor = ::MonitorFromWindow((HWND)hwnd, MONITOR_DEFAULTTONEAREST);
	return ImGui_ImplWin32_opengl_GetDpiScaleForMonitor(monitor);
}
...
static float ImGui_ImplWin32_GetWindowDpiScale(ImGuiViewport* viewport)
{
	ImGuiViewportDataWin32* data = (ImGuiViewportDataWin32*)viewport->PlatformUserData;
	IM_ASSERT(data->Hwnd != 0);
	return ImGui_ImplWin32_opengl_GetDpiScaleForHwnd(data->Hwnd);
}
...
static LRESULT CALLBACK ImGui_ImplWin32_opengl_WndProcHandler_PlatformWindow(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	if (ImGui_ImplWin32_opengl_WndProcHandler(hWnd, msg, wParam, lParam))
		return true;
...
static BOOL CALLBACK ImGui_ImplWin32_UpdateMonitors_EnumFunc(HMONITOR monitor, HDC, LPRECT, LPARAM)
{
	...
	imgui_monitor.DpiScale = ImGui_ImplWin32_opengl_GetDpiScaleForMonitor(monitor);
...
static void ImGui_ImplWin32_InitPlatformInterface()
{
	...
	wcex.lpfnWndProc = ImGui_ImplWin32_opengl_WndProcHandler_PlatformWindow;
	wcex.cbClsExtra = 0;
	wcex.cbWndExtra = 0;
